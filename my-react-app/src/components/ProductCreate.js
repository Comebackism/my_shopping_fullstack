...
export default function ProductCreate() {
  ...
  // โหลดรายการหมวดหมู่ที่มีอยู่จากฐานข้อมูลมาใส่ใน Dropdown อัตโนมัติ
  useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!selectedCategory) {
      setMessage({ type: "error", text: "กรุณาระบุหมวดหมู่สินค้า" });
      return;
    }
    ...
    api.post("/api/products", {
      ...
      .then((res) => {
        setMessage({ type: "success", text: "เพิ่มสินค้าใหม่เรียบร้อยแล้ว!" });
        setTimeout(() => navigate("/admin/products"), 1200);
      })
      .catch((err) => {
        let msg = "เพิ่มสินค้าไม่สำเร็จ กรุณาลองใหม่อีกครั้ง";
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">เพิ่มสินค้าใหม่</h2>
          <p className="text-sm text-slate-500 mt-0.5">กรอกข้อมูลรายละเอียดสินค้าและอัปโหลดรูปภาพลงระบบ</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input 
              ...
              placeholder="เช่น Premium Heavyweight T-Shirt" 
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="บอกเล่าจุดเด่น เนื้อผ้า คุณภาพการตัดเย็บ..." 
              rows="3" 
                ...
                {!image ? (
                  ...
                  <div className="flex items-center gap-4 rounded-xl border border-slate-200 bg-white p-3 shadow-2xs">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-500 mt-1">รูปภาพจะถูกบันทึกพร้อมข้อมูลสินค้า</p>
                    </div>
